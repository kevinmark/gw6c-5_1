/*
---------------------------------------------------------------------------
 $Id: tsp_local.c,v 1.46 2007/12/12 15:04:15 cnepveu Exp $
---------------------------------------------------------------------------
...
void tspSetEnv(char *Variable, char *Value, int Flag)
{
  ...
  if( Variable != NULL  &&  Value != NULL )
  {
    ...
    if( retCode != 0 )
    {
      ...
      Display( LOG_LEVEL_1, ELError, HEX_STR_ERR_SETENV, Variable, strerror(errno) );
    }
  }
}
    ...
    */

    {
      ...
      else if (pid == 0) // child
      {
        ...
        // Run template script to setup interface.
